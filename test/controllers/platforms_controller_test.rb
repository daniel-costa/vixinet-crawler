...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { base_url: @platform.base_url, entry_validation: @platform.entry_validation, name: @platform.name } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { base_url: @platform.base_url, entry_validation: @platform.entry_validation, name: @platform.name } }
